...
export default function LCM6003() {
    return (
        <>
            <Hero />
            <section className="ocm" id="ocm3001" aria-labelledby="ocm-title">
                <div className="ocm__container">
                    ...
                    <header className="ocm__header">
                        ...
                        <h1 className="ocm__title" id="ocm-title">Typ UC-M600-3</h1>
                        <p className="ocm__subtitle">Umkleide mit WC, 2 Duschen & 2 Umkleidekabinen.</p>
                    </header>
                    ...
                    <div className="ocm__grid">
                        <div className="ocm__copy">
                            <p>
                                Das UC-M600-3 ist ein 20-Fuß-Modul mit getrenntem WC, zwei vollwertigen Duschkabinen, zwei Umkleidekabinen sowie einer durchgehenden Schließfachwand mit Sitzbank. Ideal für Baustellen, Sport- und Eventanlagen – kompakt, hygienisch und sofort einsatzbereit.
                                </p>    
                        </div>
                        ...
                        <div className="ocms__card_container">
                            ...
                            <article className="ocms__card">
                                ...
                                <dl className="ocms__dl">
                                    ...
                                    <div className="ocms__row">
                                        <dt>Aufteilung:</dt><dd>Vorbereich mit 2 Waschbecken an der Frontseite, 1 WC-Kabine, 2 Duschkabinen, 3 Umkleidekabinen</dd>
                                    </div>
                                    <div className="ocms__row">
                            ...
                            <article className="ocmss__card">
                                ...
                                <ul className="ocmss__list">
                                    <li><strong>Einfacher Transport:</strong> Stapel- & kranbar, gabelstaplertauglich</li>
                                    ...
                                    <li><strong><i>Optional auf Anfrage</i>:</strong> Zusätzliche Spinde/Bänke, mehr Duschen, Boiler/Warmwasser, Heizung/Klimaanlage, individuelle Farbgestaltung und Fenster/Türen</li>
                                </ul>
                            </article>
                        ...
                        <div className="ocms__card_container">
                            ...
                            <article className="ocms__card">
                                ...
                                <ul className="ocms__list">
                                    ...
                                    <li>2 Steckdosen im Trockenbereich</li>
                                    <li>2 Lichtschalter</li>
                                    <li>2 LED-Deckenleuchten (Feuchtraum)</li>
                                    <li><strong><i>Schräg montierte Wandsteckdose für Reinigung/Service</i></strong></li>
                                </ul>
                            </article>
                            ...
                            <article className="ocms__card">
                                ...
                                <ul className="ocms__list">
                                    <li><strong>Einfacher Transport:</strong> Stapel- & kranbar, gabelstaplertauglich</li>
                                    <li><strong>Sofort betriebsbereit:</strong> Werkseitig vorinstallierte Elektro- und Sanitärtechnik</li>
                                    <li><strong>Tür:</strong> 1 Eingangstür aus Aluminium 880×2050 mm, 1 Tür fürs WC, 2 Türen für Duschen, 2 Türen für Umkleidekabinen.</li>
                                    <li><strong>Fenster:</strong> 2 Kippfenster ca. 600×600 mm, je eines an jeder Schmalseite.</li>
