...
export default function LCM3001() {
    return (
        <>
            <Hero />
            <section className="ocm" id="ocm3001" aria-labelledby="ocm-title">
                <div className="ocm__container">
                    ...
                    <header className="ocm__header">
                        ...
                        <h1 className="ocm__title" id="ocm-title">Typ UC-M300-1</h1>
                        <p className="ocm__subtitle">Umkleidecontainer mit Spinden & Sitzbänken.</p>
                    </header>
                    ...
                    <div className="ocm__grid">
                        <div className="ocm__copy">
                            <p>
                                Der LC-M300-1 ist ein kompakter Umkleideraum mit Spindzeilen an den Längsseiten und zwei Sitzbänken in der Mitte. Mit einer Fläche von <strong>7,31&nbsp;m²</strong> bietet er strukturierte Aufbewahrung und komfortables Umkleiden auf kleinem Raum – ideal für Baustellen, Sport-/Eventbereiche und temporäre Unterkünfte..
                            </p>
                        </div>
                        ...
                        <div className="ocms__card_container">
                            ...
                            <article className="ocmss__card">
                                ...
                                <ul className="ocmss__list">
                                    <li><strong>Ordnung & Komfort:</strong> Separater Stauraum und bequeme Sitzgelegenheiten</li>
                                    <li><strong>Sofort betriebsbereit:</strong> Vorinstallierte Elektrokomponenten</li>
                                    <li><strong>Langlebig & pflegeleicht:</strong> Widerstandsfähige Materialien für Innen-/Außeneinsatz</li>
                                    <li><strong>Individuell anpassbar:</strong> Anzahl/Größe der Spinde, Bank-/Hakenlayout, zusätzliche Fenster/Türen, Sonderfarbe</li>
                                </ul>
                            </article>
                            ...
                            <article className="ocms__card">
                                ...
                                <ul className="ocms__list">
                                    ...
                                    <li><strong>Innenausbau:</strong> Helle, pflegeleichte Oberflächen</li>
                                    <li><strong>Tür:</strong> 1 Außentür 880 × 2050 mm</li>
                                    <li><strong>Fenster:</strong> 1 Kippfenster zur natürlichen Lüftung</li>
                                    <li><strong>Möblierung:</strong> Mehrere Spinde (abschließbar), 2 Sitzbänke; optional Haken-/Ablageleisten</li>
                                </ul>
                            </article>
                        </div>
                    </div >
