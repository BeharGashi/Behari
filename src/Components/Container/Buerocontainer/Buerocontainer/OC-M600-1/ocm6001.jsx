            ...
            <section className="ocm" id="ocm3001" aria-labelledby="ocm-title">
                <div className="ocm__container">
                    ...
                    <header className="ocm__header">
                        ...
                        <h1 className="ocm__title" id="ocm-title">Typ OC-M600-1</h1>
                    ...
                    <div className="ocm__grid">
                        <div className="ocm__copy">
                            <p>
                                Der OC-M600-1 ist ein hochwertiger, vielseitig einsetzbarer
                                Bürocontainer mit einer Fläche von <strong>14,76&nbsp;m²</strong>.
                            </p>
                            <p>
                        ...
                        <div className="ocms__card_container">
                            ...
                            <article className="ocmss__card">
                                ...
                                <ul className="ocmss__list">
                                    <li><strong>Doppelarbeitsplatz:</strong> Ideal für 2 Personen mit Besprechungsbereich</li>
                                    <li><strong>Voll ausgestattet:</strong>  Inklusive Elektrik – direkt einsatzbereit</li>
                                    <li><strong>Langlebig & wetterbeständig:</strong> Geeignet für den Außen- und Innenbereich</li>
                                    <li><strong>Flexibel einsetzbar:</strong> Büro, Verkaufsraum, Kontrollstation, u.v.m.</li>
                                    <li><strong>Kranbar & gabelstaplergeeignet:</strong> Für einfachen Transport und Aufbau</li>
                            ...
                            <article className="ocms__card">
                                ...
                                <ul className="ocms__list">
                                    ...
                                    <li><strong>Fenster:</strong> Kunststofffenster 2050×1450&nbsp;mm mit integriertem Rollladen (RAL&nbsp;9002)</li>
                                </ul>
                            </article>
                        </div>
                    </div >
