...
export default function OCM6002() {
    return (
        <>
            <Hero />
            <section className="ocm" id="ocm3001" aria-labelledby="ocm-title">
                <div className="ocm__container">
                    ...
                    <header className="ocm__header">
                        ...
                        <h1 className="ocm__title" id="ocm-title">Typ OC-M600-2</h1>
                    ...
                    <div className="ocm__grid">
                        <div className="ocm__copy">
                            ...
                            <p>
                                Der OC-M600-2 ist ein intelligenter Bürocontainer mit zwei voneinander getrennten Räumen – ideal für Unternehmen, die mehrere Teams, Abteilungen oder Funktionen gleichzeitig unterbringen möchten.
Mit einer Gesamtfläche von 14,76 m² und zwei getrennten Eingängen bietet dieses Modell maximale Flexibilität bei minimalem Platzbedarf.
                            </p>
                        </div>
                        ...
                        <div className="ocms__card_container">
                            ...
                            <article className="ocmss__card">
                                ...
                                <ul className="ocmss__list">
                                    <li><strong>Zwei getrennte Büroräume:</strong> Perfekt für Doppelbelegung oder Kombination von Büro & Besprechung</li>
                                    <li><strong>Volle Privatsphäre:</strong>Separate Eingänge & Fenster pro Raum</li>
                            ...
                            <article className="ocms__card">
                                ...
                                <ul className="ocms__list">
                                    ...
                                    <li><strong>Tür:</strong> 2 Aluminiumtüren 880×2050&nbsp;mm (RAL&nbsp;9002)</li>
