...
export default function SCM6001() {
    return (
        <>
            <Hero />
            <section className="ocm" id="ocm3001" aria-labelledby="ocm-title">
                <div className="ocm__container">
                    ...
                    <header className="ocm__header">
                        ...
                        <h1 className="ocm__title" id="ocm-title">Typ SC-M600-1</h1>
                        <p className="ocm__subtitle">Damen-/Herren-WC mit barrierefreier Kabine.</p>
                    </header>
                    ...
                    <div className="ocm__grid">
                        <div className="ocm__copy">
                            <p>
                                Der SC-M600-1 kombiniert eine rollstuhlgerechte WC-Kabine, einen Damenbereich mit 2 WC-Kabinen sowie einen Herrenbereich mit 1 WC-Kabine und 2 Urinalen – jeweils mit vorgelagerten Doppelwaschbecken. Mit einer Nutzfläche von <strong>7.31&nbsp;m²</strong>bietet er hohe Kapazität und klare Bereichstrennung für Baustellen, Events und temporäre Anlagen.
                            </p>
                        </div>
                        ...
                        <div className="ocms__card_container">
                            ...
                            <article className="ocms__card">
                                ...
                                <dl className="ocms__dl">
                                    ...
                                    <div className="ocms__row">
                                        <dt>Aufteilung</dt><dd>1 barrierefreie WC-Kabine, 2 Damen-WC-Kabinen, 1 Herren-WC-Kabine + 2 Urinale </dd>
                                    </div>
                                    <div className="ocms__row">
                        ...
                        <div className="ocms__card_container">
                            ...
                            <article className="ocmss__card">
                                ...
                                <ul className="ocmss__list">
                                    <li><strong>Barrierefreier Bereich:</strong> mit großzügiger Bewegungsfläche und Haltegriffen</li>
                                    <li><strong>Hohe Nutzerkapazität:</strong> dank separater Damen-/Herren-Zonen plus Urinalen</li>
                                    <li><strong>Schnelle Inbetriebnahme:</strong>Vorinstallierte Sanitär- und Elektroinstallation</li>
                            ...
                            <article className="ocms__card">
                                ...
                                <ul className="ocms__list">
                                    ...
                                    <li><strong>Wände/Boden:</strong> Helle, pflegeleichte Flächen; Trennwände; Halte-/Stützgriffe im barrierefreien Bereich</li>
                                    <li><strong>Tür:</strong> 3 Außentüren (davon 1 barrierefrei 1100 × 2050 mm); Innentüren für die Kabinen</li>
                                    <li><strong>Fenster:</strong> 5 Kippfenster zur natürlichen Lüftung (Rückseite)</li>
                                    <li><strong>Sanitär:</strong> 4 WC, 2 Urinale, 2 Doppelwaschbecken mit Armaturen</li>
