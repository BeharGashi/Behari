...
export default function SCM6003() {
    return (
        <>
            <Hero />
            <section className="ocm" id="ocm3001" aria-labelledby="ocm-title">
                <div className="ocm__container">
                    ...
                    <header className="ocm__header">
                        ...
                        <h1 className="ocm__title" id="ocm-title">Typ SC-M600-4</h1>
                        <p className="ocm__subtitle">Duschcontainer mit 5 Kabinen.</p>
                    </header>
                    ...
                    <div className="ocm__grid">
                        <div className="ocm__copy">
                            <p>
                                Der SC-M600-4 verfügt über fünf separate Duschkabinen mit vorgelagerten Waschplätzen – ideal für Baustellen, Events und temporäre Unterkünfte. Mit einer Nutzfläche von <strong>7.31&nbsp;m²</strong>bietet er hohe Kapazität bei kompakter Grundfläche. Helle, pflegeleichte Oberflächen, Kippfenster zur natürlichen Lüftung und anschlussfertige Zu-/Abwassertechnik sorgen für eine schnelle, hygienische Inbetriebnahme.
                                </p>
                        </div>
                        ...
                        <div className="ocms__card_container">
                            ...
                            <article className="ocms__card">
                                ...
                                <dl className="ocms__dl">
                                    ...
                                    <div className="ocms__row">
                                        <dt>Aufteilung</dt><dd>5 × Dusche</dd>
                                    </div>
                                    <div className="ocms__row">
                                        <dt>Waschtisch</dt><dd> Mehrere Becken an der Front</dd>
                                    </div>
                                    <div className="ocms__row">
                        ...
                        <div className="ocms__card_container">
                            ...
                            <article className="ocmss__card">
                                ...
                                <ul className="ocmss__list">
                                    <li><strong>Hohe Duschkapazität:</strong> 6 m Länge (5 Kabinen)</li>
                            ...
                            <article className="ocms__card">
                                ...
                                <ul className="ocms__list">
                                    ...
                                    <li><strong>Tür:</strong> 1 Außentür 880 × 2050 mm; Duschabteile mit Vorhängen</li>
                                    <li><strong>Fenster:</strong> 2 Kippfenster (Stirnseiten)</li>
                                    <li><strong>Sanitär:</strong> 5 Duschplätze mit Brausearmaturen; Waschbecken mit Mischbatterien</li>
                                    <li><strong>Ablage:</strong> Haken-/Ablageleisten im Duschbereich</li>
