            ...
            <section className="ocm" id="ocm3001" aria-labelledby="ocm-title">
                <div className="ocm__container">
                    ...
                    <header className="ocm__header">
                        ...
                        <h1 className="ocm__title" id="ocm-title">Typ SC-M600-3</h1>
                        <p className="ocm__subtitle">Herren-WC-Container mit 4 Kabinen + 2 Urinalen.</p>
                    </header>
                    ...
                    <div className="ocm__grid">
                        <div className="ocm__copy">
                            <p>
                                Der SC-M600-3 bietet vier separate WC-Kabinen, einen Urinalbereich mit 2 Urinalen sowie eine Waschplatzreihe an der Front. Mit einer Nutzfläche von <strong>7.31&nbsp;m²</strong>ist er ideal für Baustellen, Events und temporäre Anlagen. Helle, pflegeleichte Oberflächen, Kippfenster zur natürlichen Lüftung und anschlussfertige Zu-/Abwassertechnik ermöglichen eine schnelle, hygienische Inbetriebnahme.
                                </p>
                        </div>
                        ...
                        <div className="ocms__card_container">
                            ...
                            <article className="ocms__card">
                                ...
                                <dl className="ocms__dl">
                                    ...
                                    <div className="ocms__row">
                                        <dt>Aufteilung</dt><dd>4 × WC-Kabinen, 2 × Urinale</dd>
                                    </div>
                                    <div className="ocms__row">
                                        <dt>Waschtisch</dt><dd> Frontale Waschplätze</dd>
                                    </div>
                                    <div className="ocms__row">
                        ...
                        <div className="ocms__card_container">
                            ...
                            <article className="ocmss__card">
                                ...
                                <ul className="ocmss__list">
                                    <li><strong>Hohe Kapazität:</strong> kurzer Durchlauf dank 4 Kabinen + Urinalzone</li>
                            ...
                            <article className="ocms__card">
                                ...
                                <ul className="ocms__list">
                                    ...
                                    <li><strong>Innenausbau:</strong> Helle, leicht zu reinigende Flächen; Trennwände je Kabine</li>
                                    <li><strong>Tür:</strong> 1 Außentür 880 × 2050 mm; 4 Innentüren für WC-Kabinen</li>
                                    <li><strong>Fenster:</strong> 5 Kippfenster zur natürlichen Lüftung</li>
                                    <li><strong>Sanitär:</strong> 4 WC, 2 Keramik-Urinale mit Spritzschutz; Waschplätze mit Mischbatterien</li>
