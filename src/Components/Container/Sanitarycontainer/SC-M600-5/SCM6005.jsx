...
export default function SCM6005() {
    return (
        <>
            <Hero />
            <section className="ocm" id="ocm3001" aria-labelledby="ocm-title">
                <div className="ocm__container">
                    ...
                    <header className="ocm__header">
                        ...
                        <h1 className="ocm__title" id="ocm-title">Typ SC-M600-5</h1>
                        <p className="ocm__subtitle">Kombi-WC- & Duschcontainer</p>
                    </header>
                    ...
                    <div className="ocm__grid">
                        <div className="ocm__copy">
                            <p>
                                Der SC-M600-5 kombiniert 2 Urinale, 2 WC-Kabinen und 2 Duschkabinen mit vorgelagertem Doppelwaschbecken. Mit einer Nutzfläche von <strong>7.31&nbsp;m²</strong>st er ideal für Baustellen, Events und temporäre Unterkünfte. Helle, pflegeleichte Oberflächen, Kippfenster zur natürlichen Lüftung und anschlussfertige Zu-/Abwassertechnik ermöglichen eine schnelle, hygienische Inbetriebnahme.
                                </p>
                        </div>
                        ...
                        <div className="ocms__card_container">
                            ...
                            <article className="ocms__card">
                                ...
                                <dl className="ocms__dl">
                                    ...
                                    <div className="ocms__row">
                                        <dt>Aufteilung</dt><dd>2 × WC, 2 × Dusche, 2 × Urinal</dd>
                                    </div>
                                    <div className="ocms__row">
                        ...
                        <div className="ocms__card_container">
                            ...
                            <article className="ocmss__card">
                                ...
                                <ul className="ocmss__list">
                                    <li><strong>Kompakte Kombilösung:</strong> WC + Urinale + Duschen in einem Modul</li>
                                    ...
                                    <li><strong>Effiziente Nutzerführung und kurze Wartezeiten durch klare Zonen</strong></li>
                            ...
                            <article className="ocms__card">
                                ...
                                <ul className="ocms__list">
                                    ...
                                    <li><strong>Innenausbau:</strong> Geflieste, leicht zu reinigende Flächen; Trennwände je Kabine</li>
                                    <li><strong>Tür:</strong> 1 Außentür 880 × 2050 mm; Innentüren für WC-Kabinen; Duschabteile mit Vorhängen</li>
                                    <li><strong>Fenster:</strong> Kippfenster je Bereich zur natürlichen Lüftung</li>
                                    <li><strong>Sanitär:</strong> 2 WC, 2 Keramik-Urinale mit Spritzschutz, 2 Duschplätze mit Brausearmaturen; Doppelwaschbecken mit Mischbatterien</li>
