...
export default function SCM6002() {
    return (
        <>
            <Hero />
            <section className="ocm" id="ocm3001" aria-labelledby="ocm-title">
                <div className="ocm__container">
                    ...
                    <header className="ocm__header">
                        ...
                        <h1 className="ocm__title" id="ocm-title">Typ SC-M600-2</h1>
                    ...
                    <div className="ocm__grid">
                        <div className="ocm__copy">
                            <p>
                                Der SC-M600-2 bietet getrennte Damen- und Herrenbereiche mit insgesamt 3 WC-Kabinen und 3 Duschkabinen, ergänzt durch Waschplätze entlang der Mittelzone. Mit einer Nutzfläche von <strong>7.31&nbsp;m²</strong>ist er ideal für Baustellen, Events und temporäre Unterkünfte. Helle, pflegeleichte Oberflächen, Kippfenster zur natürlichen Lüftung und anschlussfertige Zu-/Abwassertechnik sorgen für eine schnelle, hygienische Inbetriebnahme.
                            </p>
                        </div>
                        ...
                        <div className="ocms__card_container">
                            ...
                            <article className="ocms__card">
                                ...
                                <dl className="ocms__dl">
                                    ...
                                    <div className="ocms__row">
                                        <dt>Aufteilung</dt><dd>3 × WC, 3 × Dusche; getrennte Eingänge Damen/Herren</dd>
                                    </div>
                                    <div className="ocms__row">
                                        <dt>Waschtisch</dt><dd> Waschplätze in der Mittelzone</dd>
                                    </div>
                                    <div className="ocms__row">
                        ...
                        <div className="ocms__card_container">
                            ...
                            <article className="ocmss__card">
                                ...
                                <ul className="ocmss__list">
                                    <li><strong>Hohe Nutzerkapazität:</strong> Parallel nutzbare Damen-/Herrenbereiche</li>
                            ...
                            <article className="ocms__card">
                                ...
                                <ul className="ocms__list">
                                    ...
                                    <li><strong>Innenausbau:</strong> Helle, leicht zu reinigende Oberflächen; Trennwände je Kabine</li>
                                    <li><strong>Tür:</strong> 2 Außentüren 880 × 2050 mm; Innentüren für alle Kabinen</li>
                                    <li><strong>Fenster:</strong> Kippfenster je Bereich zur natürlichen Lüftung</li>
                                    <li><strong>Sanitär:</strong> 3 WC, 3 Duschbereiche mit Armaturen, Waschtische mit Mischbatterien</li>
