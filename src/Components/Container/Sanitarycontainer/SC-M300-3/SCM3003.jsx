...
export default function SCM3002() {
    return (
        <>
            <Hero />
            <section className="ocm" id="ocm3001" aria-labelledby="ocm-title">
                <div className="ocm__container">
                    ...
                    <header className="ocm__header">
                        ...
                        <h1 className="ocm__title" id="ocm-title">Typ SC-M300-3</h1>
                        <p className="ocm__subtitle">Duschcontainer mit 3 Kabinen.</p>
                    </header>
                    ...
                    <div className="ocm__grid">
                        <div className="ocm__copy">
                            <p>
                                Der SC-M300-3 verfügt über drei separate Duschkabinen mit vorgelagertem Doppelwaschbecken. Mit einer Nutzfläche von <strong>7.31&nbsp;m²</strong>eignet er sich ideal für Baustellen, Events und temporäre Unterkünfte. Helle, pflegeleichte Oberflächen, Kippfenster zur natürlichen Lüftung und anschlussfertige Zu-/Abwassertechnik sorgen für eine schnelle, hygienische Inbetriebnahme.
                            </p>
                        </div>
                        ...
                        <div className="ocms__card_container">
                            ...
                            <article className="ocmss__card">
                                ...
                                <ul className="ocmss__list">
                                    <li><strong>Hohe Kapazität:</strong> Drei getrennte Duschen für parallele Nutzung</li>
                            ...
                            <article className="ocms__card">
                                ...
                                <ul className="ocms__list">
                                    ...
                                    <li><strong>Tür:</strong> 1 Außentür 880 × 2050 mm; 3 Innentüren für die Duschkabinen</li>
                                    <li><strong>Fenster:</strong> 3 Kippfenster zur natürlichen Lüftung (Rückseite)</li>
                                    <li><strong>Sanitär:</strong> 3 Duschbereiche mit Brausearmatur; 1 Doppelwaschbecken mit Armaturen</li>
