            ...
            <section className="ocm" id="ocm3001" aria-labelledby="ocm-title">
                <div className="ocm__container">
                    ...
                    <header className="ocm__header">
                        ...
                        <h1 className="ocm__title" id="ocm-title">SC-M240-1</h1>
                        <p className="ocm__subtitle">Doppel-WC-Container.</p>
                    </header>
                    ...
                    <div className="ocm__grid">
                        <div className="ocm__copy">
                            <p>
                                Der SC-M240-1 verfügt über zwei vollständig getrennte WC-Kabinen, jeweils mit Handwaschbecken und Fenster. Mit einer Nutzfläche von <strong>29.53&nbsp;m²</strong>ist er ideal für Baustellen, Events und temporäre Standorte. Robuste Stahlrahmenkonstruktion, helle, leicht zu reinigende Oberflächen und anschlussfertige Zu-/Abwasseranschlüsse sorgen für schnelle Inbetriebnahme und hygienischen Betrieb.
                            </p>
                        </div>
                        ...
                        <aside className="ocm__meta" aria-label="Kurzinfos zum Modell OC-M300-1">
                            <div className="ocm__metric" aria-label="Nutzfläche 7,31 Quadratmeter">
                                <span className="ocm__metricValue">
                                    5.94 <span className="ocm__metricUnit">m²</span>
                                </span>
                        ...
                        <div className="ocms__card_container">
                            ...
                            <article className="ocms__card">
                                ...
                                <dl className="ocms__dl">
                                    <div className="ocms__row">
                                        <dt>Typ</dt><dd>SC-M240-1</dd>
                                    </div>
                                    <div className="ocms__row">
                                        <dt>Außenmaße</dt><dd>2438 × 2438&nbsp;mm</dd>
                                    </div>
                                    <div className="ocms__row">
                                        <dt>Nutzfläche</dt><dd>5,94 m²&nbsp;m²</dd>
                                    </div>
                                    <div className="ocms__row">
                            ...
                            <article className="ocms__card">
                                ...
                                <ul className="ocms__list">
                                    ...
                                    <li>1 Lichtschalter (je Kabine)</li>
                                    <li>1 LED-Deckenleuchten</li>
                                    <li>2 Steckdosen im Bereich der Waschtische</li>
                        ...
                        <div className="ocms__card_container">
                            ...
                            <article className="ocmss__card">
                                ...
                                <ul className="ocmss__list">
                                    <li><strong>Kabine:</strong> Eine getrennte Kabinen</li>
                                    <li><strong>Sofort betriebsbereit:</strong>Vorinstallierte Sanitär- und Elektrokomponenten</li>
                                    <li><strong>Hygienisch & pflegeleicht:</strong>Glatte, leicht zu reinigende Oberflächen</li>
                                    <li><strong>Langlebig & wetterbeständig:</strong>Für den Innen- und Außeneinsatz</li>
                                    <li><strong>Optional auf Anfrage:</strong> Boiler/Frostschutzheizung, Zubehör (Spiegel, Seifen-/Papierhalter), zusätzliche Fenster/Türen, Sonderfarbe</li>
                                </ul>
                            </article>
                            {/* Ausstattung */}
                            <article className="ocms__card">
                                ...
                                <ul className="ocms__list">
                                    ...
                                    <li><strong>Tür:</strong> 1 Aluminiumtüren 880 × 2050 mm</li>
                                    <li><strong>Fenster:</strong> 1 Kippfenster zur natürlichen Lüftung (Rückseite) </li>
                                    <li><strong>Innenausbau::</strong> Geflieste Wände/Boden, Trennwand zwischen den Kabinen</li>
                                    <li><strong>Sanitärausstattung:</strong> 1 × WC, 1 × Handwaschbecken mit Armaturen</li>
                                </ul>
                            </article>
