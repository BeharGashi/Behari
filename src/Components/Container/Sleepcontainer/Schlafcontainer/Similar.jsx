...
import Image1 from "../DC-M600-1/DC_M600-1-17-scaled.jpg";
import Image2 from "../DC-M600-2/DC_M600-2-27-scaled.jpg";
import Image3 from "../DC-M600-3/DC_M600-3-32-scaled.jpg";
import Image4 from "../DC-M600-4/DC_M600-4-37-scaled.jpg";
...
const ITEMS = [
  {
    ...
    img: Image1,
    title: "SchC-M600-1",
    lines: ["Außenmaße: 6058 × 2438 mm", "Nutzfläche: 14,77 m²", "Farbe: RAL 9002 (Weißgrau)"],
  },
  {
    href: "/sch-m600-2",
    img: Image2,
  ...
  },
  {
    ...
    img: Image3,
    title: "SchC-M600-3",
    lines: ["Außenmaße: 3 x 6058X2438 mm", "Nutzfläche: 44,31 m²", "Farbe: RAL 9002 (Weißgrau)"],
  },
  {
    href: "/sch-m600-4", /* sipas kërkesës tënde pa vizë */
    img: Image4,
    title: "SchC-M600-4",
    lines: ["Außenmaße: 3 x 6058X2438 mm", "Nutzfläche: 44,31 m²", "Farbe: RAL 9002 (Weißgrau)"],
  },
