...
export default function PropertyDetail150() {
  return (
    <section className="pd150">
      <div className="pd150__inner">
        {/* Title */}


        {/* Subtitle */}
        <h2 className="pd150__title">Roan 150</h2>

        {/* Features grid */}
        <div className="pd150__features">
          {features.map((f) => {
            const Ico = f.icon;
            return (
              <div className="pd150__feat" key={f.title}>
                <div className="pd150__ico">
                  <Ico />
                </div>
                <div className="pd150__fcopy">
                  <div className="pd150__ftitle">{f.title}</div>
                  <div className="pd150__fsub">{f.sub}</div>
                </div>
              </div>
            );
          })}
