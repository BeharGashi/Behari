...
export default function Banner150() {
  ...
  return (
    <section
      className="ba150-hero"
      style={{
        backgroundImage: `url("${bgUrl}")`, // përdor string-un e importuar
      }}
    >
      <div className="ba150-hero__inner">
        <div className="ba150-hero__text">
          <h1>
            ROANI 140 <br />
            Einfamilienhaus
          </h1>
          ...
          <button className="ba150-btn">Aus unserer Galerie</button>
        </div>

        <div className="ba150-hero__visual">
          {/* Foto rrethore */}
          <div className="ba150-circle">
            <img src={typeof styleCircle === "string" ? styleCircle : (styleCircle?.default ?? "")} alt="Plant" />
          </div>

          {/* Harku i gjelbër me animim */}
          <svg className="ba150-arc" viewBox="-50 -50 100 100" aria-hidden="true">
            <path
