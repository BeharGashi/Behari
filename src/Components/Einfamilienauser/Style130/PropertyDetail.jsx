  ...
  return (
    <section className="pd">
      <div className="pd__inner">
        ...
        {/* Subtitle */}
        <h2 className="pd__title">Roan 130</h2>
        ...
        <div className="pd__features">
          {features.map((f) => {
            const Ico = f.icon;
            return (
              <div className="pd__feat" key={f.title}>
                <div className="pd__ico">
                  <Ico />
                </div>
                <div className="pd__fcopy">
                  <div className="pd__ftitle">{f.title}</div>
                  <div className="pd__fsub">{f.sub}</div>
                </div>
              </div>
            );
          })}
