...
import "./Style140_2.css";
import Banner from "./Banner140_2";
import Details from './PropertyDetail140_2'
import Amenities140 from './Amenities140_2'
import FloorPlans from './FloorPlans140_2'
...
export default function Style140_2() {
  // fotot e galerisë
  const items = useMemo(
    () => [
      ...
      { src: Style4, alt: "Style 130 – 4", tall: true  },
    ...
    <div className="s130t7wrap">
      ...
      <section className="g130t7">
        ...
        {open && (
          ...
          >
            <div
              className="st142__lbInner"
              onClick={(e) => e.stopPropagation()}
            >
              <button
                className="st142__lbClose"
                onClick={close}
                aria-label="Close"
              >
                ×
              ...
              <button
                className="st142__lbNav st142__lbNav--prev"
                onClick={prev}
                aria-label="Previous"
              >
                ‹
              ...
              <img
                className="st142__lbImg"
                src={items[idx].src}
                alt={items[idx].alt}
              />
              <button
                className="st142__lbNav st142__lbNav--next"
                onClick={next}
                aria-label="Next"
              >
                ›
              </button>
              <div className="st142__lbCaption">{items[idx].alt}</div>
            </div>
          </div>
        )}
      </section>
