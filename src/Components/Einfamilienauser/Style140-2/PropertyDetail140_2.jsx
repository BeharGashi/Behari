...
import './PropertyDetail140_2.css'
...
export default function PropertyDetail140_2() {
  return (
    <section className="pd142">
      <div className="pd142__inner">
        {/* Title / Subtitle */}
        <h2 className="pd142__title">ROAN 130-2</h2>

        {/* Features grid */}
        <div className="pd142__features">
          {features.map((f) => {
            const Ico = f.icon;
            return (
              <div className="pd142__feat" key={f.title}>
                <div className="pd142__ico">
                  <Ico />
                </div>
                <div className="pd142__fcopy">
                  <div className="pd142__ftitle">{f.title}</div>
                  <div className="pd142__fsub">{f.sub}</div>
                </div>
              </div>
            );
          })}
