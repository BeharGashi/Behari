...
export default function Banner150_2() {
  ...
  return (
    <section
      className="ba152-hero"
      style={{
        backgroundImage: `url("${bgUrl}")`, // përdor string-un e importuar
      }}
    >
      <div className="ba152-hero__inner">
        <div className="ba152-hero__text">
          <h1>
            ROANI 140 <br />
            Einfamilienhaus
          </h1>
          ...
          <button className="ba152-btn">Aus unserer Galerie</button>
        </div>

        <div className="ba152-hero__visual">
          {/* Foto rrethore */}
          <div className="ba152-circle">
            <img src={typeof styleCircle === "string" ? styleCircle : (styleCircle?.default ?? "")} alt="Plant" />
          </div>

          {/* Harku i gjelbër me animim */}
          <svg className="ba152-arc" viewBox="-50 -50 100 100" aria-hidden="true">
            <path
