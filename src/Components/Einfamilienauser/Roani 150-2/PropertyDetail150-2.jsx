...
import './PropertyDetail150-2.css'
...
const features = [
  ...
  { icon: IconGuest,   title: "GAST",         sub: "11.33 m²" },
];



export default function PropertyDetail150_2() {
  return (
    <section className="pd152">
      <div className="pd152__inner">
        {/* Title */}


        {/* Subtitle */}
        <h2 className="pd152__title">Roan 140</h2>

        {/* Features grid */}
        <div className="pd152__features">
          {features.map((f) => {
            const Ico = f.icon;
            return (
              <div className="pd152__feat" key={f.title}>
                <div className="pd152__ico">
                  <Ico />
                </div>
                <div className="pd152__fcopy">
                  <div className="pd152__ftitle">{f.title}</div>
                  <div className="pd152__fsub">{f.sub}</div>
                </div>
              </div>
            );
          })}
