...
export default function PropertyDetail150_2() {
  return (
    <section className="hspd">
      <div className="hspd__inner">
        {/* Title */}


        {/* Subtitle */}
        <h2 className="hspd__title">Roan 140</h2>

        {/* Features grid */}
        <div className="hspd__features">
          {features.map((f) => {
            const Ico = f.icon;
            return (
              <div className="hspd__feat" key={f.title}>
                <div className="hspd__ico">
                  <Ico />
                </div>
                <div className="hspd__fcopy">
                  <div className="hspd__ftitle">{f.title}</div>
                  <div className="hspd__fsub">{f.sub}</div>
                </div>
              </div>
            );
          })}
