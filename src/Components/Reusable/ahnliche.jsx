...
import Image1 from "../Container/Sanitarycontainer/SC-M240-1/SC_M240-1-1-2-scaled.jpg";
import Image2 from "../Container/Sanitarycontainer/SC-M300-1/SC_M300-1-7-scaled.jpg";
import Image3 from "../Container/Sanitarycontainer/SC-M300-2/SC_M300-2-12-scaled.jpg";
import Image4 from "../Container/Sanitarycontainer/SC-M300-3/SC_M300-3-17-scaled.jpg";
import Image5 from "../Container/Sanitarycontainer/SC-M600-1/SC_M600-1-22-scaled.jpg";
import Image6 from "../Container/Sanitarycontainer/SC-M600-2/SC_M600-2-27-scaled.jpg";
import Image7 from "../Container/Sanitarycontainer/SC-M600-3/SC_M600-3-32-scaled.jpg";
import Image8 from "../Container/Sanitarycontainer/SC-M600-4/SC_M600-4-37-scaled.jpg";
import Image9 from "../Container/Sanitarycontainer/SC-M600-5/SC_M600-5-42-scaled.jpg";
import Image10 from "../Container/Sanitarycontainer/SC-M600-6/SC_M600-6-47-scaled.jpg";
import Image11 from "../Container/Sanitarycontainer/SC-M600-7/SC_M600-7-52-scaled.jpg";
...
const ITEMS = [
  {
    ...
    img: Image1,
    title: "SC-M240-1",
    lines: ["Außenmaße: 2248 × 2438 mm", "Nutzfläche: 5,94 m²", "Farbe: RAL 9002 (Weißgrau)"],
  },
  {
    href: "/sc-m300-1",
    img: Image2,
  ...
  {
    href: "/sc-m300-3", /* sipas kërkesës tënde pa vizë */
    img: Image4,
    title: "SC-M300-3",
    lines: ["Außenmaße: 3000 × 2438 mm", "Nutzfläche: 7,31 m²", "Farbe: RAL 9002 (Weißgrau)"],
  },
  ...
  },
  {
    ...
    img: Image10,
    title: "SC M600-6",
    lines: ["Außenmaße: 6058 × 4876 mm", "Nutzfläche: 29,53 m²", "Farbe: RAL 9002 (Weißgrau)"],
  },
    {
    href: "/sc-m600-7",
    img: Image11,
    title: "SC M600-7",
    lines: ["Außenmaße: 4/6058 × 2438 mm", "Nutzfläche: 58,88 m²", "Farbe: RAL 9002 (Weißgrau)"],
  },
];
