...
export default function Mamipropertydetail() {
  return (
    <section className="mapd">
      <div className="mapd__inner">
        {/* Title */}


        {/* Subtitle */}
        <h2 className="mapd__title">MARA</h2>

        {/* Features grid */}
        <div className="mapd__features">
          {features.map((f) => {
            const Ico = f.icon;
            return (
              <div className="mapd__feat" key={f.title}>
                <div className="mapd__ico">
                  <Ico />
                </div>
                <div className="mapd__fcopy">
                  <div className="mapd__ftitle">{f.title}</div>
                  <div className="mapd__fsub">{f.sub}</div>
                </div>
              </div>
            );
          })}
