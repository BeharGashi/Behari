...
import "./Whirlpool.css"; // reuses the same bright luxury styles (.sb2)
    ...
    <header className="hero-copy wipe">
      <div className="wipe-target">
        ...
        <h1 className="headline">
          Whirlpool <em><br/>Luxus-Niveau</em>
        </h1>
        <p className="lead">
           Hydrotherapie mit präzisen Jets, ergonomischen Sitz- & Liegezonen,
                leiser Technik und effizienter Energie – für maximale Regeneration.
        </p>

        <div className="chips" role="list">
          <span role="listitem" className="chip">Hydrojet Massage</span>
          <span role="listitem" className="chip">Air Bubbles & Chromotherapie</span>
          <span role="listitem" className="chip">Wärmepumpe & Ozon/UV</span>
        </div>
      </div>
    </header>
      ...
      <section id="leistungen" className="benefits container">
        <div className="stagger line-grid">
          <article className="line-card">
            <IconThermo />
            <h3>Jets & Ergonomie</h3>
            <p>Zonierte Düsen, Rücken/Nacken/Beine – individuell einstellbar, ergonomisch geformt.</p>
          </article>
          <article className="line-card">
            <IconSteam />
            <h3>Luftsprudel & Wellness</h3>
            <p>Feine Luftblasen, Chromotherapie & Ambientebeleuchtung für tiefe Entspannung.</p>
          </article>
          <article className="line-card">
            <IconLeaf />
            <h3>Wärme & Isolation</h3>
            <p>Schnelles Aufheizen, hochwertige Isolierung & Abdeckung – niedrige Betriebskosten.</p>
          </article>
          <article className="line-card">
            <IconLight />
            <h3>Steuerung & Hygiene</h3>
            <p>App-Control, Ozon/UV-Aufbereitung, leise Pumpen – sauber & smart.</p>
          </article>
        </div>
      </section>
      ...
      <section id="galerie" className="showcase container">
        ...
        <div className="dia-grid">
          <figure className="shot span7 photo-reveal ripple">
            ...
            <figcaption>Ergonomie & Zonen</figcaption>
          </figure>
          <figure className="shot span5 photo-reveal ripple">
            ...
            <figcaption>Jets & Massage</figcaption>
          </figure>
      ...
      <section className="process container">
        ...
        <ol className="steps">
          <li>
            ...
            <div>
              <h4>Planung</h4>
              <p>Standort, Ergonomie, Technik & Strom/Wasser – klar abgestimmt.</p>
            </div>
          </li>
          <li>
            <span className="dot">2</span>
            <div>
              <h4>Wanne & Leitungen</h4>
              <p>Schale, Rohre, Abdichtung – sauber verlegt & geprüft.</p>
            </div>
          </li>
          <li>
            ...
            <div>
              ...
              <p>Pumpen, Heizung, Steuerung, Ozon/UV – Messwerte & Einregelung.</p>
            </div>
          </li>
          <li>
            ...
            <div>
              ...
              <p>Einweisung, Pflegeplan, Wartung – dauerhaft kristallklares Wasser.</p>
            </div>
          </li>
        </ol>
      </section>
