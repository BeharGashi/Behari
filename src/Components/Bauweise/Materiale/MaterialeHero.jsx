        ...
        <div className="mat-overlay">
          <div className="mat-content">
            <h1 className="mat-title">
              Hochwertige Materialien <br /> Nachhaltig & Langlebig
            </h1>
            <p className="mat-short">Für höchste Qualität und Wohnkomfort setzen wir auf erstklassige,
nachhaltige Materialien – für ein gesundes und energieeffizientes Zuhause.</p>
          </div>
        </div>
      </section>
